...
class TensorField(Generic[TensorT], Field[TensorT]):
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(self, other.__class__):
            ...
            return (
                numpy.array_equal(self.tensor, other.tensor)
                and self.padding_value == other.padding_value
            )
    ...
    def __repr__(self) -> str:
        return (
            f"TensorField(tensor={self._tensor}, padding_value={self._padding_value})"
        )
